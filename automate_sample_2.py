...
with pd.ExcelWriter(output_filename, engine='xlsxwriter') as writer:
    ...
    df_raw.to_excel(writer, sheet_name='1. Raw Employee Data', index=False)
    df_calc.to_excel(writer, sheet_name='2. Salary Calculations', index=False) 
    pivot_table.to_excel(writer, sheet_name='3. Department Summary')
    avg_table.to_excel(writer, sheet_name='4. Salary Analysis')
    ...
    ws_calc = writer.sheets['2. Salary Calculations']
    ...
    ws_summary = writer.sheets['3. Department Summary']
    ...
    ws_insights = writer.sheets['4. Salary Analysis']
...
ws_summary = wb['3. Department Summary']
...
print("Report Generated: 'Company_Payroll_Report.xlsx'")
print("\n" + "="*60)
print("REPORT CONTENTS:")
print("1. Raw Employee Data - Original input data")
print("2. Salary Calculations - Detailed individual calculations")
print("3. Department Summary - Budget analysis for management")
print("4. Salary Analysis - Compensation trends by department")
print("="*60)
